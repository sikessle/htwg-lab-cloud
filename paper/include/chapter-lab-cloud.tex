...
eines Professors an. Nähere Informationen über das Dashboard sind im folgenden Kapitel
\ref{horizon} zu finden. 
Für die Teilnehmer einer Vorlesung kann daraufhin eine virtuelle Maschine
...
Die Details zum soeben genannten Überblick sind in den nachfolgenden 
Unterkapiteln nachzulesen. 
Dabei werden die internen Abläufe beim Anzeigen von Vorlesungen in Openstack, dem Starten, Stoppen
und Aktualisieren von virtuellen Maschinen Instanzen beschrieben.
